...
ris334=$($PATH_ARDUINO/arduino --verify --board arduino:avr:due DW2040DUEF40SP1_REV1.3.3.4/DW2040DUEF40SP1_REV1.3.3.4.ino -v | grep DW2040DUEF40SP1_REV1.3.3.4.cpp.bin | cut -d\  -f 5)
ris338=$($PATH_ARDUINO/arduino --verify  --board arduino:avr:due DW2040DUEF40SP1_REV1.3.3.8/DW2040DUEF40SP1_REV1.3.3.8.ino -v | grep DW2040DUEF40SP1_REV1.3.3.8.cpp.bin | cut -d\  -f 5)
